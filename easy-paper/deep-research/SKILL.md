...
**简体中文**: 研究, 深度研究, 文献回顾, 文献探讨, 系统性回顾, 后设分析, 证据综整, 事实查核, 研究方法, 学术分析, 政策分析, 引导我的研究, 帮我厘清, 监测这个主题, 设定追踪
...
| Your Situation 你的状况 | Recommended Mode |
|----------------|-----------------|
...
| Have a paper to evaluate before citing / 有论文需要评估 | `review` |
...
| `references/irb_decision_tree.md` | IRB decision tree + China process + HE quick reference | ethics_review, research_architect |
